...
import com.jhs.taolibao.code.simtrade.chart.CoupleChartGestureListener;
...
/**
 * @author jiao on 2016/7/8 12:31
 * @E-mail: jiaopeirong@iruiyou.com
 * 类说明:日K
 */
public class DayKFragment extends BaseFragment2 {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_day_k, null);
    }
    ...
    private void initView() {
        combinedchart = (CombinedChart) getView().findViewById(R.id.combinedchart);
