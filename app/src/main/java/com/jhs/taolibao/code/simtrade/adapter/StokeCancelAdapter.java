 ...
 */
public class StokeCancelAdapter extends BaseAdapter {

    private Context ctx;
    private List<Stock> dataList;
    public StokeCancelAdapter(Context context,List<Stock> dataList){
        this.ctx = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvStyle.setTextColor(Color.GREEN);
        ...
        if (null != stock){
            ...
            holder.tvStatus.setText(stock.getEntrustDate());
            holder.tvTime.setText(stock.getEntrustTime());
            holder.tvStyle.setText(stock.getEntrustStatus());
            holder.tvDealNum.setText(stock.getEntrustBs());
        }
        return convertView;
    }
