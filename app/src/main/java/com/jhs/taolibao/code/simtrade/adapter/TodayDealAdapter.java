...
public class TodayDealAdapter extends BaseAdapter {
    ...
    public TodayDealAdapter(Context context, List<Stock> dataList){
        this.ctx = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null != stock){
            ...
            holder.tvDeleNum.setText(stock.getBusinessTime());
            holder.tvStatus.setText(stock.getBusinessPrice());
            holder.tvTime.setText(stock.getBusinessAmount());
            holder.tvStyle.setText(stock.getEntrustBs());
            holder.tvDealNum.setText(stock.getBusinessBalance());
            holder.tvPrice.setText(stock.getEntrustDate());
        }
